...
public class CSymbolTable 
{
    ...
    public void define(CSymbol pSymbol, String pNamespace)
    {
        ...
        (
        		(
        				pSymbol.VariableScope == VariableScope.Permanent | pSymbol.VariableScope == VariableScope.Global) && !this._name.equalsIgnoreCase("global") 
                || !isNullOrEmpty(pNamespace) && (!isNullOrEmpty(this._name) && !this._name.equalsIgnoreCase(pNamespace))
        )
        {
