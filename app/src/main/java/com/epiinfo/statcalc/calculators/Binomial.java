package com.epiinfo.statcalc.calculators;

import com.epiinfo.statcalc.calculators.SharedResources;

public class Binomial {
	public double[] CalculateBinomialProbabilities(int observations, int numerator, double p)
	{
